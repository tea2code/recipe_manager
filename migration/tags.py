...
tags_001 = [
    ...
    ['Französisch', 'French'],
    ['Deutsch', 'German'],
    ['Englisch', 'English', 'Britisch', 'British'],
    ['Italienisch', 'Italian'],
    ['Japanisch', 'Japanese'],
    ['Mexikanisch', 'Mexican'],
    ['Russisch', 'Russian'],
...
tags_002 = [
    ...
    ['Belorussisch', 'Byelorussian', 'Belorussian'],
    ['Belgisch', 'Belgian'],
    ['Belizisch', 'Belizean'],
    ['Beninisch', 'Beninese'],
    ...
    ['Kanadisch', 'Canadian'],
    ['Kasachisch', 'Kazakh', 'Kazak'],
    ['Katarisch', 'Qatari'],
    ['Kenianisch', 'Kenyan'],
    ['Kiribatisch', 'Kiribatian'],
    ['Kolumbianisch', 'Colombian'],
    ['Komorisch', 'Comorian', 'Comoran'],
    ['Kongolesisch', 'Congolese'],
    ['Koreanisch', 'Korean'],
    ['Kroatisch', 'Croatian'],
    ['Kubanisch', 'Cuban'],
    ['Kuwaitisch', 'Kuwaiti'],
    ['Kyrgyzstanisch', 'Kyrgyzstani'],
    ['Laotisch', 'Laotian'],
    ['Lettisch', 'Latvian'],
    ...
    ['Luxemburgisch', 'Luxembourgian'],
    ['Makedonisch', 'Mazedonisch', 'Macedonian'],
    ...
    #['Mexikanisch', 'Mexican'],
    ['Moldawisch', 'Moldauisch', 'Moldovan'],
    ['Monegassisch', 'Monacan'],
    ['Mongolisch', 'Mongolian'],
    ['Montenegrinisch', 'Montenegrin'],
    ...
    ['Syrisch', 'Syrian'],
    ['Salvadorianisch', 'Salvadorean', 'Salvadoran'],
    ...
    ['Usbekisch', 'Uzbeg', 'Usbeg'],
    ['Ungarisch', 'Madjarisch' 'Hungarian'],
    ['Venezolanisch', 'Venezuelisch', 'Venezuelan'],
